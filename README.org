...
** Integrated package management
   ...
   - kernel, 1.1.0 (#2) Kernel Package
   - primitive, 0.0.2 (#11) Primitive Package
   - text_tools, 0.0.1 (#26) Text Tools
   - ask, 0.0.1 (#29) Ask, Query Package
   - model, 0.0.1 (#33) Model Package
   - persistent, 0.0.2 (#43) Persistent Package
   - dialog, 0.0.5 (#47) Dialog, Web Server Package
   - dialog_extras, 0.0.4 (#57) Dialog, Extras
   - mustache, 1.0.0 (#63) Mustache Templating Language Package
   - identity, 0.0.2 (#67) Identity Package
   - alt, 0.0.2 (#73) Alt, Player Package

   And a starter package:

   - application, 0.0.7 (#80) Application Package
...
** How do I start the web server?
   ...
   ~#83~ is the object number of the HTTP server object built from the
